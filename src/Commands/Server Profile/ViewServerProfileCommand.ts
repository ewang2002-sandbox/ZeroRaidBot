...
export class ViewServerProfileCommand extends Command {
    ...
    public async executeCommand(
        ...
        const lRSB: StringBuilder = new StringBuilder()
            .append("General Runs")
            .appendLine()
            .append(`- Completed: ${typeof leaderRuns === "undefined" ? 0 : leaderRuns.general.completed}`)
            .appendLine()
            .append(`- Failed: ${typeof leaderRuns === "undefined" ? 0 : leaderRuns.general.failed}`)
            .appendLine()
            .append(`- Assisted: ${typeof leaderRuns === "undefined" ? 0 : leaderRuns.general.assists}`)
            .appendLine()
            .appendLine()
            // new sect
            .append("Endgame Runs")
