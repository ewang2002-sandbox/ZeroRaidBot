...
export module RaidHandler {
	...
	export async function startAfkCheck(
		...
		let vcLimit: number = typeof SECTION.properties.raidVcLimit === "undefined" ? 50 : SECTION.properties.raidVcLimit;
		const NEW_RAID_VC: VoiceChannel = vcToUse || await guild.channels.create(`🚦 Raiding ${newRaidNum}`, {
			...
			userLimit: vcLimit > 99 ? undefined : vcLimit
		});
